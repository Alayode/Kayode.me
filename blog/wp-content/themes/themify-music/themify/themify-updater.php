...
add_action( 'after_setup_theme', 'themify_refresh_versions' );
		...
		if ( is_object( $newT ) && ( $theme_version < $newT->version ) ) {
			if ( $_GET['page'] == 'themify' ) {
				if ( isset( $area ) && 'tab' == $area ) {
					$theme_notifications = sprintf( __( '<a href="%s" title="" class="%s updateready" target="%s">Update Now</a> <p class="update %s">%s version %s is now available. View the <a href="http://themify.me/logs/%s-changelogs" target="_blank"
 data-changelog="http://themify.me/changelogs/%s.txt" class="themify_changelogs">change log</a> for details.</p>', 'themify' ),
						$newT->url,
						( isset( $area ) && 'tab' == $area ) ? $newT->class . ' button big-button' : $newT->class,
						$newT->target,
						$newT->login,
						$theme_label,
						$newT->version,
...
<a href="http://themify.me/logs/%s-changelogs" target="_blank" data-changelog="http://themify.me/changelogs/%s.txt" class="themify_changelogs">change log</a> for details.</p>', 'themify' ),
						$newT->login,
						$theme_label,
						$newT->version,
						$newT->url,
				...
				$theme_notifications = '<p class="update">' . sprintf( __( '%s version %s is now available. Visit the <a href="admin.php?page=themify">%s page</a> to update.', 'themify' ),
					$theme_label,
					$newT->version,
					$theme_label
				) . '</p>';
			...
			if ( $_GET['page'] == 'themify' ) {
				if ( isset( $area ) && 'tab' == $area ) {
					...
					$fw_notifications = '<p class="update">' . sprintf( __( 'Framework version %s is now available. <a href="%s" title="" class="%s" target="%s">Update Now</a> or view the <a href="http://themify.me/logs/framework-changelogs" data-changelog="http://themify.me/changelogs/themify.txt" class="themify_changelogs">change log</a> for details.', 'themify' ),
							$newF->version,
							$newF->url,
							( isset( $area ) && 'tab' == $area ) ? $newF->class . ' button big-button' : $newF->class,
							$newF->target
						) . '</p>';
				}
			} else {
				$fw_notifications = '<p class="update">' . sprintf( __( 'Framework version %s is now available. Visit the <a href="admin.php?page=themify">%s page</a> to update.', 'themify' ),
					$newF->version,
					$theme_label
				) . '</p>';
			}
...
available. View the <a href='http://themify.me/logs/%s-changelogs' title='' class='themify_changelogs' target='_blank' data-changelog='http://themify.me/changelogs/%s.txt'>change log</a>
 for details.</p>", 'themify' ),
							$url,
							$class,
							$target,
							$login,
...
view the <a href='http://themify.me/logs/%s-changelogs' title='' class='themify_changelogs' target='_blank' data-changelog='http://themify.me/changelogs/%s.txt'>change log</a> for
 details.</p>", 'themify' ),
							$login,
							$theme_label,
							$update['_v'],
	...
	if ( isset( $area ) && 'tab' == $area ) {
		if ( '' == $theme_notifications ) {
			...
			$theme_notifications = sprintf( __( '<p class="update %s"><a href="%s" class="%s" target="%s">Re-install Theme</a></p><p>Re-install the theme with the latest version.</p>', 'themify' ),
				isset( $login ) ? $login . ' reinstalltheme' : $newT->login . ' reinstalltheme',
				isset( $url ) ? $url : $newT->url,
				isset( $class ) ? $class . ' button big-button' : $newT->class . ' button big-button',
				isset( $target ) ? $target : $newT->target
			);
			$notifications .= $theme_notifications;
		}
