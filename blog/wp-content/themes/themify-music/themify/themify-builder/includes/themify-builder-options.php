			...
			?>
				<div class="themify_builder_input<?php echo isset($field['pushed']) && $field['pushed'] != '' ? ' '.$field['pushed'] : ''; ?>">
					<?php if( 'text' == $field['type'] ): ?>
						...
						<?php else : ?>
							<input id="<?php echo $field['id'] ?>" name="<?php echo $field['id'] ?>" value="<?php if(isset($field['value'])) echo $field['value']; ?>" class="<?php echo isset( $field['class'] ) ? $field['class'] : '' ?> <?php echo isset( $add_class ) ? $add_class : ''; ?> tfb_lb_option" type="text" <?php echo themify_builder_get_binding_data( $field ); ?> />
					...
					<?php elseif( 'checkbox' == $field['type'] ): ?>
						<?php if( isset( $field['before'] ) ) echo $field['before']; ?>
...
if ( ! function_exists( 'themify_builder_styling_field' ) ) {
	...
	function themify_builder_styling_field( $styling ){
		switch ($styling['type']) {
			...
			case 'checkbox':
				if( isset( $styling['before'] ) ) echo $styling['before'];
				?>
				<div id="<?php echo $styling['id']; ?>" class="tfb_lb_option themify-checkbox">
				<?php foreach( $styling['options'] as $opt): ?>
					...
					?>
					<input id="<?php echo $styling['id'] . '_' . $opt['name']; ?>" name="<?php echo $styling['id']; ?>" type="checkbox" class="tfb_lb_option tf-checkbox" value="<?php echo $opt['name']?>" <?php echo $checkbox_checked; ?> /> 
					<label for="<?php echo $styling['id'] . '_' . $opt['name']; ?>" class="pad-right"><?php echo $opt['value']; ?></label>
				...
				<?php
				if( isset( $styling['after'] ) ) echo $styling['after'];
			break;
